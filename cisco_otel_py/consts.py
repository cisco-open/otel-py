...
ALLOWED_EXPORTER_TYPES = [HTTP_EXPORTER_TYPE, GRPC_EXPORTER_TYPE, CONSOLE_EXPORTER_TYPE, TEST_EXPORTER_TYPE]
...
WRAPPED_INSTRUMENTATION_KEYS = [REQUESTS_KEY, GRPC_SERVER_KEY, GRPC_CLIENT_KEY]
