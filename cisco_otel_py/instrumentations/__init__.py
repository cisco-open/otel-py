...
class BaseInstrumentorWrapper:
    ...
    def generic_request_handler(self,  # pylint: disable=R0912
                                ...
                                request_body,
                                span: Span) -> Span:
        return self._generic_handler(self._process_request_headers, SemanticAttributes.HTTP_REQUEST_HEADER.key,
                                     self._process_request_body, SemanticAttributes.HTTP_REQUEST_BODY.key,
    ...
    def generic_response_handler(self,  # pylint: disable=R0912
        ...
        return self._generic_handler(self._process_response_headers, SemanticAttributes.HTTP_RESPONSE_HEADER.key,
                                     self._process_response_body, SemanticAttributes.HTTP_RESPONSE_BODY.key,
