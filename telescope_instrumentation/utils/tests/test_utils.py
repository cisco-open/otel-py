...
class TestUtils(unittest.TestCase):
    ...
    def test_lowered_case_items(self):
        lowered_items = Utils.lowercase_items(
    ...
    def test_add_flattened_dict(self):
        test_dict = Utils.lowercase_items(
            {"Cisco-Label": "Don't touch me", "Another One": "YAP"}
        )

        Utils.add_flattened_dict(self._test_span, "test.attrs", test_dict)
    ...
    def test_set_payload_sanity(self):
        Utils.set_payload(self._test_span, "test.payload", "test payload")
        self.assertEqual(self._test_span.attributes.get("test.payload"), "test payload")

    def test_set_payload_none(self):
        Utils.set_payload(self._test_span, "test.payload", None)
    ...
    def test_set_payload_bytes_sanity(self):
        ...
        Utils.set_payload(self._test_span, "test.payload", payload)
