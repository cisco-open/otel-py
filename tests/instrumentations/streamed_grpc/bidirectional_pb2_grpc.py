...
from tests.instrumentations.streamed_grpc import bidirectional_pb2 as tests_dot_instrumentations_dot_streamed__grpc_dot_bidirectional__pb2
...
class Bidirectional(object):
    ...
    def SendMessage(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/bidirectional.Bidirectional/SendMessage',
